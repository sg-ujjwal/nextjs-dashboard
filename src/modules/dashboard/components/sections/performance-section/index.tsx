        ...
        {PERFORMANCE_CARDS.map((card) => {
          ...
          return (
            ...
            >
              ...
              >
                {isBest ? <Trophy size={20} color="#fff" /> : <CircleAlert size={20} color="#fff" />}
              </Box>
              <Box sx={{ minWidth: 0, flex: 1 }}>
                <Typography sx={{ fontSize: '0.75rem', fontWeight: 600, color: 'text.secondary', textTransform: 'uppercase', letterSpacing: '0.06em', mb: 0.25 }}>
                  {card.title}
                </Typography>
                <Typography sx={{ fontSize: '0.875rem', fontWeight: 700, color: 'text.primary' }}>{card.deployment}</Typography>
              </Box>
              <Box
                sx={{
                  display: 'flex',
