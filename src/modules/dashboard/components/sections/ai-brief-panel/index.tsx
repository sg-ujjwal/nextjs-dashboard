...
import { PRIORITY_CARDS, DEPLOYMENT_ALERTS, STRATEGIC_FORECASTING } from '@/modules/dashboard/services/dashboard-data'
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            <Typography sx={{ fontSize: '1rem', fontWeight: 700, color: '#fff' }}>AI Executive Brief</Typography>
      ...
      <Box sx={{ p: 2.5, flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
        <Box>
          ...
          <Box key={alert.id} sx={{ borderRadius: CARD_BORDER_RADIUS_SX, p: 2, border: '1px solid rgba(254, 215, 170, 0.5)', bgcolor: '#fff7ed' }}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
              ...
              <Box>
                ...
                <Button
                  type="button"
                  sx={{ mt: 1, p: 0, minWidth: 0, fontSize: '0.75rem', fontWeight: 700, color: '#9a3412', textTransform: 'none', '&:hover': { bgcolor: 'transparent', textDecoration: 'underline' } }}
                >
                  View
                </Button>
              </Box>
