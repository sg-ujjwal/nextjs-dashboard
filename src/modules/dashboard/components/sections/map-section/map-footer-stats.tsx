...
export const MapFooterStats = ({
  ...
  >
    <Box sx={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1, px: 2, py: 1.5, minWidth: 0 }}>
      ...
      <Typography sx={{ fontSize: '0.875rem', fontWeight: 700, flexShrink: 0 }}>{activeDeployment}</Typography>
    </Box>
    <Box
      sx={{
        flex: 1,
    ...
    >
      ...
      <Typography sx={{ fontSize: '0.875rem', fontWeight: 700, flexShrink: 0 }}>${capitalDeployed.toFixed(1)}M</Typography>
    </Box>
    <Box
      sx={{
        flex: 1,
    ...
    >
      ...
      <Typography sx={{ fontSize: '0.875rem', fontWeight: 700, flexShrink: 0 }}>{highAlerts}</Typography>
    </Box>
    <Box
      sx={{
        flex: 1,
    ...
    >
      ...
      <Typography sx={{ fontSize: '0.875rem', fontWeight: 700, flexShrink: 0 }}>{diversification}/100</Typography>
