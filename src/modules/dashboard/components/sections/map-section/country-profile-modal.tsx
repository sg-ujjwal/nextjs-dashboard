...
import { getDefaultIntelligence, parseActiveDeployment } from './map-marker-helpers'
...
export const CountryProfileModal = ({ marker, onClose }: CountryProfileModalProps) => {
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 1.5, mb: 2 }}>
        ...
        <Button
          ...
          sx={{
            ...
            borderRadius: CARD_BORDER_RADIUS_SX,
            color: 'text.disabled',
            '&:hover': { bgcolor: 'rgba(255,255,255,0.8)', color: 'text.primary' },
          }}
        >
          <X size={18} />
        </Button>
